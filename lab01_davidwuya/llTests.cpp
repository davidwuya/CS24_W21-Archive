...
int main(int argc, char* argv[]) {
  if(argc < 2) {
    ...
    if (testNum == 1) {
      ...
      if(pointerToMax(list1) != 0) { //pointer not nullptr
	...
	ASSERT_EQUALS(57, pointerToMax(list1)->next->data);
      ...
      if(pointerToMax(list2) != 0) { //pointer not nullptr
	...
	ASSERT_EQUALS(3, pointerToMax(list4)->next->data);
      ...
      if(pointerToMin(list1) != 0) { //pointer not nullptr
	...
	ASSERT_EQUALS(57, pointerToMin(list1)->next->data);
      ...
      if(pointerToMin(list2) != 0) { //pointer not nullptr
